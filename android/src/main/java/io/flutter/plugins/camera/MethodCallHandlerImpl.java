...
final class MethodCallHandlerImpl implements MethodChannel.MethodCallHandler {
    ...
    MethodCallHandlerImpl(Activity activity, BinaryMessenger messenger, CameraPermissions cameraPermissions, PermissionsRegistry permissionsAdder, TextureRegistry textureRegistry) {
    ...
    public void onMethodCall(@NonNull MethodCall call, @NonNull final Result result) {
        switch (call.method) {
            ...
            case "initialize": {
                ...
                cameraPermissions.requestPermissions(activity, permissionsRegistry, Boolean.TRUE.equals(call.argument("enableAudio")), (String errCode, String errDesc) -> {
                    if (errCode == null) {
                        try {
    ...
    private void instantiateCamera(MethodCall call, Result result) throws CameraAccessException {
        ...
        boolean enableAudio = Boolean.TRUE.equals(call.argument("enableAudio"));
        boolean autoFocusEnabled = Boolean.TRUE.equals(call.argument("autoFocusEnabled"));
        boolean enableAutoExposure = Boolean.TRUE.equals(call.argument("enableAutoExposure"));
        ...
        camera = new Camera(activity, flutterSurfaceTexture, dartMessenger, cameraName, resolutionPreset, enableAudio, autoFocusEnabled, enableAutoExposure, flashMode);
